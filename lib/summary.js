...
/**
 * Gets the summary file path for a given report name.
 * @param {Object} report.
 * @returns {String} summary path.
 */
function getSummaryPath(name) {
    return `${summaryPath}/${name}.json`;
}
...
function write(report) {
    let filePath = getSummaryPath(report.name);
